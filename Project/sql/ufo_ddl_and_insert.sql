...
DROP TABLE Involves CASCADE CONSTRAINTS;
DROP TABLE Investigates CASCADE CONSTRAINTS;
DROP TABLE Classifies CASCADE CONSTRAINTS;
DROP TABLE Visual CASCADE CONSTRAINTS;
DROP TABLE Audio CASCADE CONSTRAINTS;
DROP TABLE ResolutionAspect CASCADE CONSTRAINTS;
DROP TABLE Observation CASCADE CONSTRAINTS;
DROP TABLE Conclusion CASCADE CONSTRAINTS;
DROP TABLE Report CASCADE CONSTRAINTS;
DROP TABLE Reporter CASCADE CONSTRAINTS;
DROP TABLE Encounter CASCADE CONSTRAINTS;
DROP TABLE Encounter_Location CASCADE CONSTRAINTS;
...
INSERT INTO Encounter VALUES (101, 37.5669826, 126.97823520, 10, 'Y', CURRENT_TIMESTAMP, 'clear');
INSERT INTO Encounter VALUES (102, 35.689506, 139.6917, 15, 'Y', CURRENT_TIMESTAMP, 'cloudy');
INSERT INTO Encounter VALUES (103, -33.9220161, 18.4195824, 20, 'Y', CURRENT_TIMESTAMP, 'sunny');
...
INSERT INTO Involves VALUES (101, 1);
INSERT INTO Involves VALUES (102, 1);
